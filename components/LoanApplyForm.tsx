        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              name="amount"
              id="amount"
              className="block w-full pl-8 pr-4 py-3 bg-zinc-900 border border-zinc-800 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all text-lg font-semibold"
              placeholder="0.00"
              required
              min="100"
              max="50000"
